 ...
 */
class getDomaineTachesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DomaineTachesRepository' shared autowired service.
     *
     * @return \App\Repository\DomaineTachesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DomaineTachesRepository.php';

        return $container->privates['App\\Repository\\DomaineTachesRepository'] = new \App\Repository\DomaineTachesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
