 ...
 */
class getBacRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BacRepository' shared autowired service.
     *
     * @return \App\Repository\BacRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BacRepository.php';

        return $container->privates['App\\Repository\\BacRepository'] = new \App\Repository\BacRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
