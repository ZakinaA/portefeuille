 ...
 */
class getDomaineStageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DomaineStageRepository' shared autowired service.
     *
     * @return \App\Repository\DomaineStageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DomaineStageRepository.php';

        return $container->privates['App\\Repository\\DomaineStageRepository'] = new \App\Repository\DomaineStageRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
