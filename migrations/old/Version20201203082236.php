 ...
 */
final class Version20201203082236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, etudiant_id INT DEFAULT NULL, ville_id INT DEFAULT NULL, enseignant_id INT DEFAULT NULL, coordonneestut VARCHAR(50) DEFAULT NULL, teltut INT DEFAULT NULL, mailtut VARCHAR(50) DEFAULT NULL, lieu VARCHAR(50) DEFAULT NULL, nbsemaine INT DEFAULT NULL, nomentreprise VARCHAR(100) DEFAULT NULL, adrentreprise VARCHAR(50) DEFAULT NULL, directeur VARCHAR(50) DEFAULT NULL, codenaf VARCHAR(5) DEFAULT NULL, siret VARCHAR(15) DEFAULT NULL, telentreprise INT NOT NULL, faxentreprise VARCHAR(25) DEFAULT NULL, mailentreprise VARCHAR(50) DEFAULT NULL, date_debut DATE DEFAULT NULL, date_fin DATE DEFAULT NULL, sujet VARCHAR(50) DEFAULT NULL, hor_lun INT DEFAULT NULL, hor_mar INT DEFAULT NULL, hor_mer INT DEFAULT NULL, hor_jeu INT DEFAULT NULL, hor_ven INT DEFAULT NULL, hor_sam INT DEFAULT NULL, INDEX IDX_C27C9369DDEAB1A3 (etudiant_id), INDEX IDX_C27C9369A73F0036 (ville_id), INDEX IDX_C27C9369E455FCC0 (enseignant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
